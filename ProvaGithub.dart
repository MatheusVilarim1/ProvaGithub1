...
void main() {
  ...
  int? PosicaoInicial = int.parse(stdin.readLineSync() as String);

  print("Digite a velocidade inicial do veículo em metro por segundo: ");
  int? VelocidadeInicial = int.parse(stdin.readLineSync() as String);

  print("Digite a aceleração em metros por segundo: ");
  int? Aceleracao = int.parse(stdin.readLineSync() as String);
  ...
  print("A sua posição final é: ${PosicaoFinal} metros");
}
